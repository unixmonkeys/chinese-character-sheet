...
{
% Draw the X
\draw[\insidegridcolor,dashed,thin] \pointE -- \pointC;
\draw[\insidegridcolor,dashed,thin] \pointF -- \pointD;
% Draw the +
\draw[\insidegridcolor,dashed,thin] \pointG -- \pointH;
\draw[\insidegridcolor,dashed,thin] \pointI -- \pointJ;
